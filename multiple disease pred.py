...
if (selected == 'Lung Cancer Prediction'):
    ...
    with col1:
        Pregnancies = st.text_input('Name')
        
    with col2:
        Glucose = st.text_input('Surname')
    
    with col3:
        BloodPressure = st.text_input('Age')
    
    with col1:
        SkinThickness = st.text_input('Smokes')
    
    with col2:
        Insulin = st.text_input('AreaQ')
    
    with col3:
        BMI = st.text_input('Alkhol')
    ...
    if st.button('Lung Cuncer Test Result'):
        Lung_prediction = lung_cuncer_model.predict([[Name, Surname, Age, Smokes, AreaQ, Alkhol,]])
